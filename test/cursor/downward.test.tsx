...
describe("downward", () => {
   ...
   * +---+---+---+      +---+---+---+
   */
  it("should move the cursor to the end of the cell below", () => {
    const actual = (
      <editor>
        <table>
          <thead>
   ...
   * +---+---+---+      +---+---+---+
   */
  it("should move the cursor to the start of the cell below", () => {
    const actual = (
      <editor>
        <table>
          <thead>
   ...
   * +---+---+---+      +---+---+---+
   */
  it("should move the cursor to the start of the cell below when selection is in rowspan", () => {
    const actual = (
      <editor>
        <table>
          <tbody>
